      ...
      <div className="flex gap-6 items-start">
        ...
        <main className={`min-w-0 transition-all duration-200 ${showPanel ? "flex-1" : "mx-auto max-w-3xl w-full"}`}>
            ...
            {chapter.practiceQuestionIds.length > 0 && (
              <button
                onClick={() => {
                  ...
                  router.push(`${basePath}/practice?themes=${themes}`);
                }}
          ...
          <div className="mt-8 flex gap-3">
            {prevChapter && (
              <button
                onClick={() => router.push(`${basePath}/learn/${prevChapter.id}`)}
            ...
            {nextChapter && (
              <button
                onClick={() => router.push(`${basePath}/learn/${nextChapter.id}`)}
